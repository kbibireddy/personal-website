...
export default function Home() {
  ...
  const getThemeClasses = (theme: Theme) => {
    switch (theme) {
      case 'netflix':
        return 'bg-[#141414] text-white';
      case 'meta':
        return 'bg-white text-[#050505]';
      case 'discord':
        return 'bg-[#313338] text-white';
      default:
        return 'bg-[#141414] text-white';
    }
  };
  ...
  return (
    <main className={`min-h-screen p-8 md:p-24 transition-colors duration-300 ${getThemeClasses(theme)}`}>
      ...
      >
        ...
        <section className="mb-12">
          ...
          <p className={`text-lg ${getThemeClasses(theme)} text-current/90 ${getCardBgClass(theme)} p-6 rounded-lg`}>
